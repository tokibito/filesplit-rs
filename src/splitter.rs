...
mod tests {
    ...
    fn test_split_file_exact_chunks() {
        ...
        temp_file
            .write_all(b"0123456789abcdefghij1234567890")
            .unwrap();
        ...
        let file1 = temp_dir
            .path()
            .join(format!("{}.001", base_name.to_string_lossy()));
        let file2 = temp_dir
            .path()
            .join(format!("{}.002", base_name.to_string_lossy()));
        let file3 = temp_dir
            .path()
            .join(format!("{}.003", base_name.to_string_lossy()));
